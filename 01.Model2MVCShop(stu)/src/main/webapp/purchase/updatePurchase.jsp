...
<%
	...
	System.out.println(" 1  updatePurchase.jsp : " + purchaseVo );
%>
...
<% System.out.println(" 2  updatePurchase.jsp : " + purchaseVo.getTranNo() ); %>
	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
				...
				<option value="1" <%= purchaseVo.getPaymentOption().equals("1") ? "selected":"" %>>현금구매</option>
				<option value="2" <%= purchaseVo.getPaymentOption().equals("2") ? "selected":"" %>>신용구매</option>
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
					<a href="/listProduct.do?menu=search">취소</a>
				</td>
				<td width="14" height="23">
					<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
				</td>
