	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">내가 좋아요한 상품</td>
				</tr>
			</table>
		</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<tr>
		<td class="ct_list_b" width="200">NO</td>
    ...
    <tr class="ct_list_pop">
        <td align="center" colspan="100%">좋아요를 누르면 위시리스트에 등록됩니다.</td>
    </tr>
    <tr>
    ...
    <c:set var="i" value="${ i+1 }" />
        <tr class="ct_list_pop">
            ...
            <td></td>
				    ...
				    <td align="left">
				        <a href="javascript:void(0);" onclick="redirectUser('/getProduct.do?prodNo=${vo.likeProdNo.prodNo}&menu=search')">구경하기</a>
				    </td>
