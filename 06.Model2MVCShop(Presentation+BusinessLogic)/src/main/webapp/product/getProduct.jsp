		    ...
		    <c:otherwise>
			    ...
			    <c:choose>
			        <c:when test="${pushLikeNo1 == 0}">
			            <a href="addLike.do?pushLikeNo=1&prodNo=${prodVo.prodNo}&menu=search&countLikeProd=${countLikeProd}">
			                <img src="/images/like_btn.png" width="20" height="20"/>
			            </a>
			        </c:when>
			        <c:otherwise>
			            <a href="deleteLike.do?pushLikeNo=0&prodNo=${prodVo.prodNo}&menu=search&countLikeProd=${countLikeProd}">
